...
public class FloatingActionButton extends ImageButton {
  ...
  private void updateCircleSize() {
    mCircleSize = getDimension(mSize == SIZE_NORMAL ? R.dimen.fab_size_normal_utils : R.dimen.fab_size_mini_utils);
  }
  ...
  */
  ...
  void updateBackground() {
    ...
    LayerDrawable layerDrawable = new LayerDrawable(
        new Drawable[] {
            getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.c_shouye_bigmap_fab_bg_normal : R.drawable.c_shouye_bigmap_fab_bg_mini),
